...
wp_enqueue_style('awl-bootstrap-css', MS_PLUGIN_URL .'css/bootstrap.css');
wp_enqueue_script('awl-bootstrap-js', MS_PLUGIN_URL .'js/bootstrap.js', array('jquery'), '' , true);
wp_enqueue_style('thickbox');
wp_enqueue_style('fp-bootstrap-css', MS_PLUGIN_URL.'featured-plugins/css/bootstrap.css');
wp_enqueue_style('fp-smartech-css', MS_PLUGIN_URL.'featured-plugins/css/smartech.css');
wp_enqueue_style('fp-feature-plugins', MS_PLUGIN_URL.'featured-plugins/css/feature-plugins.css');	
wp_enqueue_script('jquery');
wp_enqueue_script('fp-media-uploads',MS_PLUGIN_URL.'js/featured-plugins/acl-media-upload-script.js',array('media-upload','thickbox','jquery')); 
wp_enqueue_script('fp-bootstrap-min-js',MS_PLUGIN_URL.'js/featured-plugins/bootstrap.min.js');
