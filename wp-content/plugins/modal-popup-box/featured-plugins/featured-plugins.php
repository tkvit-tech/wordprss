...
wp_enqueue_style('awl-mpb-bootstrap-css', MPB_PLUGIN_URL .'css/bootstrap.css');
wp_enqueue_script('awl-mpb-bootstrap-js', MPB_PLUGIN_URL .'js/bootstrap.js', array('jquery'), '' , true);
wp_enqueue_style('thickbox');
wp_enqueue_style('mpb-bootstrap-css', MPB_PLUGIN_URL.'featured-plugins/css/bootstrap.css');
wp_enqueue_style('mpb-smartech-css', MPB_PLUGIN_URL.'featured-plugins/css/smartech.css');
wp_enqueue_style('mpb-feature-plugins', MPB_PLUGIN_URL.'featured-plugins/css/feature-plugins.css');	
wp_enqueue_script('jquery');
wp_enqueue_script('mpb-media-uploads',MPB_PLUGIN_URL.'js/featured-plugins/acl-media-upload-script.js',array('media-upload','thickbox','jquery')); 
wp_enqueue_script('mpb-bootstrap-min-js',MPB_PLUGIN_URL.'js/featured-plugins/bootstrap.min.js');
...
<div class="wrap">
	<h2 class="hndle text-center" style="background-color: #073b4c;"><span><?php _e("Get More Free WordPress Plugin From A WP Life"); ?></span></h2>	
