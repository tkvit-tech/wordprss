				...
				<div class="row">
					<div class="col-md-4">
						<div class="ma_field_discription">
							<h5><?php esc_html_e( 'Show Modal Popup Button Setting', 'modal-popup-box' ); ?></h5>
							<p><?php esc_html_e( 'Display modal form on page load OR on button click', 'modal-popup-box' ); ?></p> 
						</div>
					</div>
					<div class="col-md-8">
						<div class="ma_field p-4 switch-field em_size_field">
							...
							<input type="radio" class="form-control" id="mpb_show_modal1" name="mpb_show_modal" value="onload" 
							<?php
							...
							<input type="radio" class="form-control" id="mpb_show_modal2" name="mpb_show_modal" value="onclick" 
							<?php
					...
					<div class="col-md-8">
						<div class="ma_field p-4">
							...
							<input type="text" id="mpb_main_button_text" class="selectbox_settings" name="mpb_main_button_text" value="<?php echo esc_html( $mpb_main_button_text ); ?>" placeholder="Type Button Text">
						</div>
					</div>
					<div class="col-md-4">
						<div class="ma_field_discription">
					...
					<div class="col-md-8">
						<div class="ma_field p-4">
							...
							<select id="mpb_main_button_size" class="selectbox_settings" name="mpb_main_button_size"  >
								<option value="btn btn-xs"
								<?php
								if ( $mpb_main_button_size == 'btn btn-xs' ) {
									echo 'selected=selected';}
								?>
								><?php esc_html_e( 'Small button', 'modal-popup-box' ); ?></option>
								<option value="btn btn-sm"
								<?php
								if ( $mpb_main_button_size == 'btn btn-sm' ) {
									echo 'selected=selected';}
								?>
								><?php esc_html_e( 'Medium button', 'modal-popup-box' ); ?></option>
								<option value="btn btn-lg"
								<?php
								if ( $mpb_main_button_size == 'btn btn-lg' ) {
									echo 'selected=selected';}
								?>
								><?php esc_html_e( 'Large button', 'modal-popup-box' ); ?></option>
							</select>
						</div>
					</div>
					<div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="ma_field_discription">
							...
							<p><?php esc_html_e( 'You can set Button Text Color', 'modal-popup-box' ); ?></p> 
						</div>
					</div>
					<div class="col-md-8">
						<div class="ma_field p-4">
