...
<div class="site-info">
	<div class="container">
		<?php echo '&copy; '. esc_html(date_i18n(__('Y','simpleblogily'))); ?> <?php bloginfo( 'name' ); ?>

			<!-- Delete below lines to remove copyright from footer -->
			<span class="footer-info-right">
			<?php echo __(' | Theme:', 'simpleblogily') ?> <a href="<?php echo esc_url('https://superbthemes.com/simpleblogily/', 'simpleblogily'); ?>"><?php echo __('Simple Blogily', 'simpleblogily') ?></a>
			</span>
