 ...
 */
/* Breadcrumb Begin */
function vw_construction_estate_the_breadcrumb() {
	if (!is_home()) {
		echo '<a href="';
...
function vw_construction_estate_setup() {
	...
	*/
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'vw-construction-estate') {
		wp_redirect(admin_url('themes.php?page=vw_construction_estate_guide'));
	}
...
function vw_construction_estate_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=vw_construction_estate_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-construction-estate' ) .'</a></span>';
		echo '<span class="demo-btn"><a href="'. esc_url( 'https://www.vwthemes.net/vw-construction-estate-pro/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'VIEW DEMO', 'vw-construction-estate' ) .'</a></span>';
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/themes/premium-construction-wordpress-theme/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-construction-estate' ) .'</a></span>';
	echo '</div>';
}
...
function vw_construction_estate_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Social Icon', 'vw-construction-estate' ),
		'description'   => __( 'Appears on right side footer', 'vw-construction-estate' ),
		'id'            => 'footer-icon',
...
function vw_construction_estate_scripts() {
	...
	if (get_theme_mod('vw_construction_estate_animation', true) == true){
...
if ( ! defined( 'VW_CONSTRUCTION_ESTATE_GETSTARTED_URL' ) ) {
	define( 'VW_CONSTRUCTION_ESTATE_GETSTARTED_URL', 'themes.php?page=vw_construction_estate_guide');
}
...
function vw_construction_estate_tagline_hide_show(){
	if(get_theme_mod('vw_construction_estate_tagline_hide_show',0) == '1' ) {
		return true;
	}
	return false;
}
...
//Active Callback
function vw_construction_estate_default_slider(){
	if(get_theme_mod('vw_construction_estate_slider_type', 'Default slider') == 'Default slider' ) {
		return true;
	}
	return false;
}

function vw_construction_estate_advance_slider(){
	if(get_theme_mod('vw_construction_estate_slider_type', 'Default slider') == 'Advance slider' ) {
		return true;
	}
	return false;
}

function vw_construction_estate_blog_post_featured_image_dimension(){
	if(get_theme_mod('vw_construction_estate_blog_post_featured_image_dimension') == 'custom' ) {
		return true;
	}
	return false;
}
