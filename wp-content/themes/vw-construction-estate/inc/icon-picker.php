        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-construction-estate' ); ?>">
                </div>
...
function vw_construction_estate_customizer_script() {
    ...
    wp_enqueue_script( 'vw-construction-estate-customizer-script', esc_url(get_template_directory_uri()).'/js/customizer-scripts.js', array("jquery"),'', true  );
}
